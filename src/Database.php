...
interface Database {
	 ...
	 */
	public function getLastInsertId(?string $sequenceName = null);
	 ...
	 */
	public function quoteTableName(string|array $tableName);
	 ...
	 */
	public function quoteLiteral(string $literal);
